...
func AccessBindingsByOrganization() *schema.Table {
	return &schema.Table{
		Name:        "yandex_access_bindings_by_organization",
		Resolver:    fetchAccessBindingsByOrganization,
...
func fetchAccessBindingsByOrganization(ctx context.Context, meta schema.ClientMeta, _ *schema.Resource, res chan interface{}) error {
	...
	resourceClient := c.Services.OrganizationManager.Organization()
