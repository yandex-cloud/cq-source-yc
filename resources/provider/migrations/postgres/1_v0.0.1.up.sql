...
CREATE TABLE IF NOT EXISTS "yandex_access_bindings_by_cloud" (
	...
	"subject_id" text,
	"subject_type" text,
	CONSTRAINT yandex_access_bindings_by_cloud_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "yandex_access_bindings_by_folder" (
	...
	"subject_id" text,
	"subject_type" text,
	CONSTRAINT yandex_access_bindings_by_folder_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "yandex_access_bindings_by_organization" (
	...
	"subject_id" text,
	"subject_type" text,
	CONSTRAINT yandex_access_bindings_by_organization_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "yandex_certificatemanager_certificates" (
	...
	CONSTRAINT yandex_certificatemanager_certificates_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	UNIQUE(id)
);
CREATE TABLE IF NOT EXISTS "yandex_certificatemanager_certificate_challenges" (
	...
	CONSTRAINT yandex_certificatemanager_certificate_challenges_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (certificate_cq_id) REFERENCES yandex_certificatemanager_certificates(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "yandex_compute_disks" (
	...
	CONSTRAINT yandex_compute_disks_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	UNIQUE(id)
);
...
CREATE TABLE IF NOT EXISTS "yandex_compute_images" (
	...
	"os_type" text,
	"pooled" boolean,
	CONSTRAINT yandex_compute_images_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	UNIQUE(id)
);
...
CREATE TABLE IF NOT EXISTS "yandex_compute_instances" (
	...
	CONSTRAINT yandex_compute_instances_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	UNIQUE(id)
);
CREATE TABLE IF NOT EXISTS "yandex_compute_instance_secondary_disks" (
	...
	"auto_delete" boolean,
	"disk_id" text,
	CONSTRAINT yandex_compute_instance_secondary_disks_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (instance_cq_id) REFERENCES yandex_compute_instances(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "yandex_compute_instance_local_disks" (
	...
	"size" bigint,
	"device_name" text,
	CONSTRAINT yandex_compute_instance_local_disks_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (instance_cq_id) REFERENCES yandex_compute_instances(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "yandex_compute_instance_filesystems" (
	...
	"device_name" text,
	"filesystem_id" text,
	CONSTRAINT yandex_compute_instance_filesystems_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (instance_cq_id) REFERENCES yandex_compute_instances(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "yandex_compute_instance_network_interfaces" (
	...
	CONSTRAINT yandex_compute_instance_network_interfaces_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (instance_cq_id) REFERENCES yandex_compute_instances(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "yandex_compute_instance_net_interface_ipv4_1_1_nat_dns_records" (
	...
	"ttl" bigint,
	"ptr" boolean,
	CONSTRAINT yandex_compute_instance_net_interface_ipv4_1_1_nat_dns_recor_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (network_interfaces_cq_id) REFERENCES yandex_compute_instance_network_interfaces(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "yandex_compute_instance_net_interface_ipv4_dns_records" (
	...
	"ttl" bigint,
	"ptr" boolean,
	CONSTRAINT yandex_compute_instance_net_interface_ipv4_dns_records_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (network_interfaces_cq_id) REFERENCES yandex_compute_instance_network_interfaces(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "yandex_compute_instance_net_interface_ipv6_1_1_nat_dns_records" (
	...
	"ttl" bigint,
	"ptr" boolean,
	CONSTRAINT yandex_compute_instance_net_interface_ipv6_1_1_nat_dns_recor_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (network_interfaces_cq_id) REFERENCES yandex_compute_instance_network_interfaces(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "yandex_compute_instance_net_interface_ipv6_dns_records" (
	...
	"ttl" bigint,
	"ptr" boolean,
	CONSTRAINT yandex_compute_instance_net_interface_ipv6_dns_records_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (network_interfaces_cq_id) REFERENCES yandex_compute_instance_network_interfaces(cq_id) ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "yandex_compute_instance_placement_policy_host_affinity_rules" (
	...
	"op" text,
	"values" text[],
	CONSTRAINT yandex_compute_instance_placement_policy_host_affinity_rules_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (instance_cq_id) REFERENCES yandex_compute_instances(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "yandex_iam_service_accounts" (
	...
	"description" text,
	"labels" jsonb,
	CONSTRAINT yandex_iam_service_accounts_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	UNIQUE(id)
);
...
CREATE TABLE IF NOT EXISTS "yandex_iam_user_accounts_by_cloud" (
	...
	CONSTRAINT yandex_iam_user_accounts_by_cloud_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	UNIQUE(id)
);
...
CREATE TABLE IF NOT EXISTS "yandex_iam_user_accounts_by_folder" (
	...
	"user_account_saml_user_account_name_id" text,
	"user_account_saml_user_account_attributes" jsonb,
	CONSTRAINT yandex_iam_user_accounts_by_folder_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	UNIQUE(id)
);
...
CREATE TABLE IF NOT EXISTS "yandex_iam_user_accounts_by_organization" (
	...
	"user_account_saml_user_account_name_id" text,
	"user_account_saml_user_account_attributes" jsonb,
	CONSTRAINT yandex_iam_user_accounts_by_organization_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	UNIQUE(id)
);
...
CREATE TABLE IF NOT EXISTS "yandex_k8s_clusters" (
	...
	CONSTRAINT yandex_k8s_clusters_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	UNIQUE(id)
);
...
CREATE TABLE IF NOT EXISTS "yandex_kms_symmetric_keys" (
	...
	CONSTRAINT yandex_kms_symmetric_keys_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	UNIQUE(id)
);
...
CREATE TABLE IF NOT EXISTS "yandex_object_storage_buckets" (
	...
	"cq_meta" jsonb,
	"id" text NOT NULL,
	CONSTRAINT yandex_object_storage_buckets_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	UNIQUE(id)
);
CREATE TABLE IF NOT EXISTS "yandex_object_bucket_serv_side_encrypt_config_rules" (
	...
	CONSTRAINT yandex_object_bucket_serv_side_encrypt_config_rules_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id)
);
...
CREATE TABLE IF NOT EXISTS "yandex_resourcemanager_clouds" (
	...
	"description" text,
	"organization_id" text,
	CONSTRAINT yandex_resourcemanager_clouds_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	UNIQUE(id)
);
...
CREATE TABLE IF NOT EXISTS "yandex_resourcemanager_folders" (
	...
	"description" text,
	"organization_id" text,
	CONSTRAINT yandex_resourcemanager_folders_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	UNIQUE(id)
);
...
CREATE TABLE IF NOT EXISTS "yandex_serverless_api_gateways" (
	...
	CONSTRAINT yandex_serverless_api_gateways_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	UNIQUE(id)
);
CREATE TABLE IF NOT EXISTS "yandex_apigateway_api_gateway_attached_domains" (
	...
	"enabled" boolean,
	"domain" text,
	CONSTRAINT yandex_apigateway_api_gateway_attached_domains_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	FOREIGN KEY (api_gateway_cq_id) REFERENCES yandex_serverless_api_gateways(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "yandex_vpc_addresses" (
	...
	"type" text,
	"ip_version" text,
	CONSTRAINT yandex_vpc_addresses_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	UNIQUE(id)
);
...
CREATE TABLE IF NOT EXISTS "yandex_vpc_networks" (
	...
	CONSTRAINT yandex_vpc_networks_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	UNIQUE(id)
);
...
CREATE TABLE IF NOT EXISTS "yandex_vpc_security_groups" (
	...
	CONSTRAINT yandex_vpc_security_groups_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	UNIQUE(id)
);
CREATE TABLE IF NOT EXISTS "yandex_vpc_security_group_rules" (
	...
	CONSTRAINT yandex_vpc_security_group_rules_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	UNIQUE(id),
	FOREIGN KEY (security_group_cq_id) REFERENCES yandex_vpc_security_groups(cq_id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "yandex_vpc_subnets" (
	...
	CONSTRAINT yandex_vpc_subnets_pk PRIMARY KEY(cq_id),
	UNIQUE(cq_id),
	UNIQUE(id)
);
