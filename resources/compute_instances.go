...
func ComputeInstances() *schema.Table {
	return &schema.Table{
		...
		Relations: []*schema.Table{
			...
			{
				Name:        "yandex_compute_instance_local_disks",
				Resolver:    fetchComputeInstanceLocalDisks,
				Multiplex:   client.EmptyMultiplex,
				IgnoreError: client.IgnoreErrorHandler,
				Columns: []schema.Column{
					{
			...
			{
				Name:        "yandex_compute_instance_filesystems",
				Resolver:    fetchComputeInstanceFilesystems,
				Multiplex:   client.EmptyMultiplex,
				IgnoreError: client.IgnoreErrorHandler,
				Columns: []schema.Column{
					{
					...
					},
					{
						Name:        "mode",
						Type:        schema.TypeString,
						Description: "Access mode to the filesystem.",
						Resolver:    client.EnumPathResolver("Mode"),
					},
					{
						Name:        "device_name",
...
func fetchComputeInstanceLocalDisks(_ context.Context, _ schema.ClientMeta, parent *schema.Resource, res chan<- interface{}) error {
	values := funk.Get(parent.Item, "LocalDisks")
...
func fetchComputeInstanceFilesystems(_ context.Context, _ schema.ClientMeta, parent *schema.Resource, res chan<- interface{}) error {
	values := funk.Get(parent.Item, "Filesystems")
